<template>
    <div class="commodity-details">
        <!-- <h3>商品详情</h3> -->
         ...
         <!-- 返回图标 -->
        <router-link to="/GoodListappliance"> <a class="active"><span class="mui-icon-extra         mui-icon-extra-arrowleftcricle"></span></a>
        </router-link>
    ...
    export default({
        ...
        methods: {
            ...
            loadMore(){
                ...
                console.log(lid)
                var url="http://127.0.0.1:3000/applianceDetails?lid="+lid
                this.axios.get(url).then(result=>{
