<template>
    <div class="commodity-details">
        <!-- <h3>商品详情</h3> -->
         ...
         <!-- 返回图标 -->
        <router-link to="/biye"> <a class="active"><span class="mui-icon-extra         mui-icon-extra-arrowleftcricle"></span></a>
        </router-link>
        ...
        <div class="mui-card" >
			<div class="mui-card-content">
                ...
                <div @click="shouye">
                  ...
                  <div @click="enterShopCar">
                    <img src="http://127.0.0.1:3000/img/shopcar (1).png" alt=""/>
                    <div id="a"></div>
                    <span>购物车</span>
                </div>
				<div class="mui-card-content-inner" :data-toggle="item.lid" @click="addshopcar">
                            加入购物车
				</div>
			</div>
		</div>
    ...
    export default({
        ...
        methods: {
            ...
            addshopcar(e){
                ...
                //2.向后台发送axios请求
                var url="http://127.0.0.1:3000/addProduct1?lid="+lid1
                //3.查询成功
            ...
            loadMore(){
                ...
                console.log(lid)
                var url="http://127.0.0.1:3000/biye_details?lid="+lid
                this.axios.get(url).then(result=>{
